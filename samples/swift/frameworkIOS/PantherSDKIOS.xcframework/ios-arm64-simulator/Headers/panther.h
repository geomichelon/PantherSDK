...
int32_t panther_guidelines_ingest_json(const char *guidelines_json_c);

char *panther_guidelines_similarity(const char *query_c, int32_t top_k, const char *method_c);

int32_t panther_guidelines_save_json(const char *name_c, const char *json_c);

int32_t panther_guidelines_load(const char *name_c);
...
<<<<<<< HEAD
int32_t panther_guidelines_embeddings_build(const char *method_c);
